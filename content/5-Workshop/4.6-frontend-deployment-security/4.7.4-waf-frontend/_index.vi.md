...
Khi triển khai ứng dụng bằng AWS Amplify, một Web ACL (WAF) thường đã được tự động tạo và gán cho CloudFront Distribution của frontend. Bạn không cần phải tự tạo từ đầu.
